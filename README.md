...
📍Tool: 
Open source LTspice from Analog Devices is used. 
Technology file - "ams35_CMOS.inc" used. 

📝Handwritten Notes: 
The pdf in handwritten notes folder has all the theoretical concepts explained as required. 
Derivations and analysis setup are also included.

📖Schematics: 
All the Ltspice schmatic files are uploaded in the folder Schematics in the repo.
